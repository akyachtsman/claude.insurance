...
// LOCAL DIVERGENCE: this project's design contract lives in css/, not styles/
// (predates the Repo Structure Standard). Upstream's path is KEPT rather than
// replaced, so this stays a superset and the next refresh diffs cleanly.
// Reported upstream: this list should be configurable, not hardcoded.
const CANDIDATES = ['styles/tokens.css', 'css/tokens.css'];
